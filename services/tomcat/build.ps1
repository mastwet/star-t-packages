# Build .star package for Apache Tomcat 10.1
param(
    [string]$Version = "10.1.41",
...
$packageName = "tomcat-$Version-win-x64.star"
...
# Find the extracted directory (apache-tomcat-{version})
...
# Copy Tomcat files to pkg/bin (standard .star layout)
